...
# (`relapse`). mlxtend's fpgrowth turns that into one item `relapse`, which
...
def main():
    parser = argparse.ArgumentParser(
        description="Run FP-Growth association rule mining."
    )
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="data/final/ARM/fpgrowth/top100",
    )
    ...
    print(f"FP-Growth runtime: {fpgrowth_time:.3f} seconds")
    print()
    ...
    print(f"Total runtime:      {fpgrowth_time + rule_time:.3f}s")
